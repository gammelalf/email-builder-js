...
import IfContainerSidebarPanel from './input-panels/IfContainerSidebarPanel';
...
export default function ConfigurationPanel() {
  ...
  switch (type) {
    ...
    case 'IfContainer':
      return <IfContainerSidebarPanel key={selectedBlockId} data={data} setData={(data) => setBlock({ type, data })}/>;
    default:
